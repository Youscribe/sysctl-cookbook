...
# Examples
    # set "vm.swappiness" to "60". will create /etc/sysctl.d/69-vm.wappiness.conf
    sysctl "vm.swappiness" do
      value "40"
    end
   
   # the same. will create /etc/sysctl.d/69-vm_swappiness_to_60.conf
   sysctl "vm swappiness to 60" do
     variable "vm.swappiness"
     value "60"
   end

   #remove /etc/sysctl.d/69-ip_config.conf
   sysctl "ip config" do
     action :remove
   end
